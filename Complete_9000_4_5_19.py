##9000,9005, 9004 and 9019 complete working
import sys
import csv
import boto3
import pandas as pd
...
column_names_9004,datatype_9004, rec_type_values_9004, mappings_9004, join_conditions_9004 = process_csv(csv_string_9004)

# Read the 9005 CSV and process it
csv_string_9005 = read_csv_from_s3(s3_bucket, account_staging_9005)
column_names_9005, datatype_9005, rec_type_values_9005, mappings_9005, join_conditions_9005 = process_csv(csv_string_9005)

# Read the 9005 transpose CSV and process it
csv_string_9005_transpose = read_csv_from_s3(s3_bucket, account_transpose_9005)
column_names_9005_transpose, datatype_9005_transpose, rec_type_values_9005_transpose, mappings_9005_transpose, join_conditions_9005_transpose = process_csv(csv_string_9005_transpose)

# Read the 9019 CSV and process it
csv_string_9019 = read_csv_from_s3(s3_bucket, account_staging_9019)
column_names_9019,datatype_9019, rec_type_values_9019, mappings_9019, join_conditions_9019 = process_csv(csv_string_9019)

# Read the 9019 CSV and process it
csv_string_9019_transpose = read_csv_from_s3(s3_bucket, account_transpose_9019 )
column_names_9019_transpose,datatype_9019_transpose, rec_type_values_9019_transpose, mappings_9019_transpose, join_conditions_9019_transpose = process_csv(csv_string_9019_transpose)
...
df_9005_transpose = pd.DataFrame({col: [] for col in column_names_9005_transpose})
df_9019 = pd.DataFrame({col: [] for col in column_names_9019})
df_9019_transpose = pd.DataFrame({col: [] for col in column_names_9019_transpose})
...
columns_matching_9005 = [col for col, rec_type in zip(column_names_output, rec_type_values) if rec_type == 9005]
columns_matching_9004 = [col for col, rec_type in zip(column_names_output, rec_type_values) if rec_type == 9004]
columns_matching_9019 = [col for col, rec_type in zip(column_names_output, rec_type_values) if rec_type == 9019]
...
column_datatypes_9005_transpose = [handle_datatype(val) for val in datatype_9005_transpose]
column_datatypes_9019_transpose = [handle_datatype(val) for val in datatype_9019_transpose]
