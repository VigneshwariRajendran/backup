...
# Also now composite key check for transpose,intermediate
import sys
import csv
import boto3
import pandas as pd
...
account_staging_9004 = 'lineage-vr/account_rectypes/Account_9004_Staging_test.csv'
...
def generate_composite_key_lineage(namespace, dataset_list, composite_key_columns, join_conditions):
...
# Define composite key lineage for each dataset type
composite_key_lineage_transpose_9005 = generate_composite_key_lineage(
    namespace, input_datasets["staging"], composite_key_columns, join_conditions_9005_transpose
)
composite_key_lineage_transpose_9019 = generate_composite_key_lineage(
    namespace, input_datasets["staging"], composite_key_columns, join_conditions_9019_transpose
)
composite_key_lineage_intermediate_9005 = generate_composite_key_lineage(
    namespace, input_datasets["transpose"], composite_key_columns, join_conditions
)
composite_key_lineage_intermediate_9019 = generate_composite_key_lineage(
    namespace, input_datasets["transpose"], composite_key_columns, join_conditions
)
composite_key_lineage_intermediate_9000 = generate_composite_key_lineage(
    namespace, input_datasets["staging"], composite_key_columns, join_conditions
)
composite_key_lineage_intermediate_9004 = generate_composite_key_lineage(
    namespace, input_datasets["staging"], composite_key_columns, join_conditions
)


# Update lineage schemas to include composite key lineage
...
# Update lineage for transpose datasets
lineage_transpose_9005["facets"]["columnLineage"]["fields"] = integrate_composite_key_lineage(
    ...
    composite_key_lineage_transpose_9005
)
lineage_transpose_9019["facets"]["columnLineage"]["fields"] = integrate_composite_key_lineage(
    ...
    composite_key_lineage_transpose_9019
)

# Update lineage for intermediate datasets
lineage_intermediate_9005["facets"]["columnLineage"]["fields"] = integrate_composite_key_lineage(
    lineage_intermediate_9005["facets"]["columnLineage"]["fields"],
    composite_key_lineage_intermediate_9005
)
lineage_intermediate_9019["facets"]["columnLineage"]["fields"] = integrate_composite_key_lineage(
    lineage_intermediate_9019["facets"]["columnLineage"]["fields"],
    composite_key_lineage_intermediate_9019
)
lineage_intermediate_9000["facets"]["columnLineage"]["fields"] = integrate_composite_key_lineage(
    lineage_intermediate_9000["facets"]["columnLineage"]["fields"],
    composite_key_lineage_intermediate_9000
)
lineage_intermediate_9004["facets"]["columnLineage"]["fields"] = integrate_composite_key_lineage(
    lineage_intermediate_9004["facets"]["columnLineage"]["fields"],
    composite_key_lineage_intermediate_9004
)

# Update lineage for output dataset
...
# print("Transpose 9005 Composite Key Lineage:", composite_key_lineage_transpose_9005)
# print("Transpose 9019 Composite Key Lineage:", composite_key_lineage_transpose_9019)
# print("Intermediate 9005 Composite Key Lineage:", composite_key_lineage_intermediate_9005)
# print("Intermediate 9019 Composite Key Lineage:", composite_key_lineage_intermediate_9019)
# print("Intermediate 9000 Composite Key Lineage:", composite_key_lineage_intermediate_9000)
# print("Intermediate 9004 Composite Key Lineage:", composite_key_lineage_intermediate_9004)
print("Updated Lineage Transpose 9005 Fields:", lineage_transpose_9005["facets"]["columnLineage"]["fields"])
print("Updated Lineage Intermediate 9005 Fields:", lineage_intermediate_9005["facets"]["columnLineage"]["fields"])
print("Join Conditions for 9005Transpose:", join_conditions_9005_transpose)
print("Join Conditions for 9019Transpose:", join_conditions_9019_transpose)
print("Join Conditions for Intermediate:", join_conditions)
# Validate input datasets
if not input_datasets["transpose"]:
    print("Transpose datasets are empty")
if not input_datasets["intermediate"]:
    print("Intermediate datasets are empty")

# Validate join conditions
if not any(join_conditions):
    print("Join conditions are not defined properly")
if "facets" not in lineage_transpose_9005:
    lineage_transpose_9005["facets"] = {}
if "columnLineage" not in lineage_transpose_9005["facets"]:
    lineage_transpose_9005["facets"]["columnLineage"] = {"fields": {}}
